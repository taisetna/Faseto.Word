...
namespace Faseto.Word
{
    ...
    public class WindowResizer
    {
        ...
        public WindowResizer(Window window)
        {
            ...
            m_Window.LocationChanged += Window_LocationChanged;
        }
        ...
        private void Window_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            mMonitorDpi = VisualTreeHelper.GetDpi(m_Window);
            ...
            var bottom = top + m_Window.Height;
            ...
            var edgedTop = windowTopLeft.Y <= (mScreenSize.Top + m_EdgeTolerance) && windowTopLeft.Y >= (mScreenSize.Top - m_EdgeTolerance);
            var edgedLeft = windowTopLeft.X <= (mScreenSize.Left + m_EdgeTolerance) && windowTopLeft.X >= (mScreenSize.Left - m_EdgeTolerance);
            var edgedBottom = windowBottomRight.Y >= (mScreenSize.Bottom - m_EdgeTolerance) && windowBottomRight.Y <= (mScreenSize.Bottom + m_EdgeTolerance);
            var edgedRight = windowBottomRight.X >= (mScreenSize.Right - m_EdgeTolerance) && windowBottomRight.X <= (mScreenSize.Right + m_EdgeTolerance);
        ...
        private void WmGetMinMaxInfo(System.IntPtr hwnd, System.IntPtr lParam)
        {
            ...
            if (lParam != IntPtr.Zero)
            {
                ...
                // Set min size
                var minSize = new Point(m_Window.MinWidth * mMonitorDpi.Value.DpiScaleX, m_Window.MinHeight * mMonitorDpi.Value.DpiScaleX);
